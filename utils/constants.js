module.exports = {
    ...
    server1: {
        ...
        linkOnlyChannelIds: ['1222535529934098442'],
        musicRequestChannelIds: ['1248149862185177108'],
        ...
        fontGeneratorId: '1303953316635611156'
    },
    // Konfigurasi untuk Server 2
    server2: {
        guildId: '1288595563130126346',
        allowedChannelIds: ['1288595563914465325', '1290003287659249705'],
        linkOnlyChannelIds: ['1288615004714565652'],
        musicRequestChannelIds: ['1288615465324642324'],
